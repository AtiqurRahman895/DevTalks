...
const PageVisits = () => {
  ...
  const pages = [
    { name: '/devtalks/', visitors: '4,569', uniqueUsers: '340', bounceRate: '46.53%', trend: 'up' },
    { name: '/devtalks/question', visitors: '3,985', uniqueUsers: '319', bounceRate: '46.53%', trend: 'down' },
    { name: '/devtalks/career', visitors: '3,513', uniqueUsers: '294', bounceRate: '36.49%', trend: 'down' },
    { name: '/devtalks/All_Questions', visitors: '2,050', uniqueUsers: '147', bounceRate: '50.87%', trend: 'up' },
    { name: '/devtalks/events', visitors: '1,795', uniqueUsers: '190', bounceRate: '46.53%', trend: 'down' },
  ];

  return (
    <div className="p-4 bg-[#101017] rounded-lg shadow-md">
      {/* Header */}
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-semibold text-white">Page visits</h2>
        <button className="px-4 py-1 text-sm text-white bg-custom-primary rounded-md  ">
          See all
        </button>
      </div>
